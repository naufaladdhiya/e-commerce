        ...
        <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <tbody>
                            @forelse ($cart_items as $item)
                                <tr wire:key="{{ $item['product_id'] }}">
                                    ...
                                    <td class="py-4">{{ Number::currency($item['total_amounth'], 'IDR') }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-4 text-2xl font-semibold text-slate-600">No
                                        items in the
                                        cart</td>
                                </tr>
                            @endforelse
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    @if ($cart_items)
                        <a class="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full block text-center"
